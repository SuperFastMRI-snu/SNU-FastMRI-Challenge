...
def forward(args):
    ...
    checkpoint1 = torch.load(args.exp_dir / 'best_model2_67.pt', map_location='cpu')
    checkpoint2 = torch.load(args.exp_dir / 'best_model2_67.pt', map_location='cpu')
    checkpoint3 = torch.load(args.exp_dir / 'best_model2_67.pt', map_location='cpu')
    checkpoint4 = torch.load(args.exp_dir / 'best_model2_67.pt', map_location='cpu')
