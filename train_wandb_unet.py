...
from utils.learning.train_part_wandb_unet import train
...
if __name__ == '__main__':
    ...
    def train_using_wandb():
        ...
        args.net_name = Path('unet'+str(wandb.config.cascade)+','+str(wandb.config.chans)+','+str(wandb.config.sens_chans)+','+str(wandb.config.unet_chans)+', acc '+str(args.acc[0])+' '+str(args.acc[1]))
