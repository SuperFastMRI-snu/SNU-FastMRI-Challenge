...
`sh reconstruct.sh` saves the reconstructed image files generated by the model, which were forwarded through the leaderboard dataset, to `root/result/FIVarNet_submit/reconstructions_leaderboard`.
